...
const firebaseConfig = {
  ...
  storageBucket: import.meta.env.VITE_FIREBASE_STORAGE_BUCKET || "labsnatural.appspot.com",
...
// Initialize Firestore with settings for better stability in restricted environments
